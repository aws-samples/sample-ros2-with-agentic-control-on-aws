...
class RobotData:
    ...
    # Raw low-state dict from the robot — used to populate the
    # `LowState` ROS2 message (battery, foot forces, motor temps, IMU).
    low_state_raw: Optional[Dict[str, Any]] = None
